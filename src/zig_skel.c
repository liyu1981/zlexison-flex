...
const char *skel[] = {
  ...
  "		yy_current_buffer.yy_ch_buf = (try self.allocator.realloc(yy_current_buffer.yy_ch_buf[0..yyg.yy_n_chars], new_size)).ptr;",
  ...
  "	//",
  "    b.yy_ch_buf = (try self.allocator.alloc(u8, b.yy_buf_size + 2)).ptr;",
  ...
  "        self.allocator.free(b.yy_ch_buf[0..b.yy_n_chars]);",
  "    }",
  "",
  ...
  "        yyg.yy_buffer_stack = (try self.allocator.alloc(?*yy_buffer_state, num_to_alloc)).ptr;",
  ...
  "    var yyg = try allocator.create(yyguts_t);",
  "    _ = &yyg;",
  "",
  ...
  "",
  "    yyg.yy_state_buf = (self.allocator.alloc(usize, YY_STATE_BUF_SIZE) catch {",
