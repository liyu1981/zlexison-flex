...
const char *skel[] = {
  ...
  "    _ = this;",
  "}",
  "pub const YYSTYPE = m4_ifdef([[M4_ZLEX_WITH_PARSER_TYPE]], [[@import(\"parser_type.zig\").YYSTYPE]], [[struct {}]]);",
  ...
  "",
  "    m4_define( [[M4_YY_LEX_PROTO]],",
  "               [[(this: *Self, yylval: *YYSTYPE, yylloc: *YYLTYPE)]])",
  "]])",
  "",
  "%endif",
  "",
