...
const char *skel[] = {
  ...
  "",
  "pub extern fn yywrap (yyg: *yyguts_t) usize;",
  "pub extern fn YY_USER_ACTION(this: *Self) anyerror!void;",
  "pub extern fn YY_USER_INIT(this: *Self) anyerror!void;",
  "pub const YYSTYPE = opaque{};",
  "pub const YYLTYPE = opaque{};",
  ...
  "/// main buffer.",
  "pub const YY_STATE_BUF_SIZE = (YY_BUF_SIZE + 2) * @sizeOf(usize);",
  "",
  ...
  "",
  "		if (yyg.yy_buffer_stack[yyg.yy_buffer_stack_top] != 0) {",
  "		    yyensure_buffer_stack(yyg);",
  "            yyg.yy_buffer_stack[yyg.yy_buffer_stack_top].* = try yy_create_buffer(yyg.yyin, YY_BUF_SIZE, yyg);",
  "		}",
  "",
  ...
  "		            const yy_amount_of_matched_text: c_int = (yy_cp - YY_G(yytext_ptr)) - 1;",
  "",
  ...
  "                        yyg.yy_buffer_stack[yyg.yy_buffer_stack_top].yy_input_file = yyg.yyin;",
  ...
  "",
  "                        yy_bp = YY_G(yytext_ptr) + yyg.yy_more_len;",
  "",
  "                        if ( yy_next_state ) {",
  "                            // /* Consume the NUL. */",
  ...
  "                            continue;",
  "	            		}",
  "		            } else switch (yy_get_next_buffer(yyg)) {",
  "                        EOB_ACT_END_OF_FILE => {",
  ...
  "                                //",
  "                                YY_G(yy_c_buf_p) = YY_G(yytext_ptr) + yyg.yy_more_len;",
  "",
  ...
  "                        EOB_ACT_LAST_MATCH => {",
  "                            YY_G(yy_c_buf_p) =",
  "                            &yyg.yy_buffer_stack[yyg.yy_buffer_stack_top].yy_ch_buf[YY_G(yy_n_chars)];",
  "",
  "                            yy_current_state = yy_get_previous_state(yyg);",
  "",
  "                            yy_cp = YY_G(yy_c_buf_p);",
  ...
  "	var number_to_move: c_int = undefined;",
  ...
  "		if ((yyg.yy_c_buf_p - yyg.yytext_r) - yyg.yy_more_len == 1 ) {",
  ...
  "	number_to_move = (yyg.yy_c_buf_p - yyg.yytext_r) - 1;",
  "",
  ...
  "",
  "		// Read in more data.",
  "		YY_INPUT(yy_current_buffer.yy_ch_buf[number_to_move], &yyg.yy_n_chars, num_to_read, yyg);",
  "",
  ...
  "		yy_current_buffer.yy_ch_buf = try yyg.allocator.realloc(u8, yy_current_buffer.yy_ch_buf, new_size);",
  ...
  "///",
  "pub fn yy_try_NUL_trans(yy_current_state: usize, yyg: *yyguts_t) usize {",
  ...
  "		} else {",
  "            // need more input",
  "			const offset: usize = yyg.yy_c_buf_p - yyg.yytext_r;",
  "			yyg.yy_c_buf_p += 1;",
  "",
  "            const nb = yy_get_next_buffer(yyg);",
  "			switch (nb) {",
  ...
  "	if (yy_current_buffer == 0) {",
  "        yyensure_buffer_stack(yyg);",
  "		yy_current_buffer.* = try yy_create_buffer(yyg.yyin, YY_BUF_SIZE, yyg);",
  "	}",
  ...
  "        yyg.yy_buffer_stack = try self.allocator.alloc(*yy_buffer_state, num_to_alloc);",
  ...
  "			yyg.yy_start_stack = try self.allocator.alloc(usize, new_size);",
  "		} else {",
  "			yyg.yy_start_stack = try self.allocator.realloc(usize, yyg.yy_start_stack, new_size);",
  "        }",
  "",
  "	    yyg.yy_start_stack[yyg.yy_start_stack_ptr] = YY_START(self);",
