...
const char *skel[] = {
  ...
  "M4_YY_SC_DEFS",
  "",
  "pub inline fn createZeroYyguts(this: *Self) !*yyguts_t {",
  "    const yyg = try Self.createZero(this.allocator, yyguts_t);",
  "    yyg.lexer = this;",
  "    return yyg;",
  "}",
  "",
  ...
  "    _ = &yy_current_state_;",
  "",
  "    const LOOP_START_YY_ACT = 0x0001;",
  "    const LOOP_START_YY_FIND_RULE = LOOP_START_YY_ACT | 0x0002;",
  "    const LOOP_START_YY_FIND_ACTION = LOOP_START_YY_FIND_RULE | 0x0004;",
  "    const LOOP_START_YY_MATCH = LOOP_START_YY_FIND_ACTION | 0x0008;",
  "    const LOOP_START_INIT = LOOP_START_YY_MATCH | 0x0010;",
  ...
  "",
  "                            yy_act = YY_STATE_EOF(this.YY_START());",
  "                            // break :do_action;",
  ...
  "        yy_current_buffer.yy_ch_buf = (try yyg.lexer.allocator.realloc(yy_current_buffer.yy_ch_buf[0..yyg.yy_n_chars], new_size)).ptr;",
  ...
  "    var b: *yy_buffer_state = try createZero(yyg.lexer.allocator, yy_buffer_state);",
  "    b.yy_buf_size = size;",
  "",
  "	// yy_ch_buf has to be 2 characters longer than the size given because",
  "	// we need to put in 2 end-of-buffer characters.",
  "	//",
  "    b.yy_ch_buf = (try yyg.lexer.allocator.alloc(u8, b.yy_buf_size + 2)).ptr;",
  ...
  "        yyg.lexer.allocator.free(b.yy_ch_buf[0..b.yy_n_chars]);",
  "    }",
  "",
  "    yyg.lexer.allocator.destroy(b);",
  "}",
  "",
  ...
  "        yyg.yy_buffer_stack = (try yyg.lexer.allocator.alloc(?*yy_buffer_state, num_to_alloc)).ptr;",
  ...
  "    }",
  "",
  "    b = try yyg.lexer.allocator.create(yy_buffer_state);",
  "",
  ...
  "    var buf = try yyg.lexer.allocator.alloc(u8, n);",
  "    @memcpy(buf, yybytes);",
  ...
  "        }",
  "",
  "        yyg.yy_start_stack[yyg.yy_start_stack_ptr] = YY_START(yyg.lexer);",
  ...
  "/// using our macros.",
  "///",
  "pub fn yylex_init(allocator: std.mem.Allocator) !Self {",
  "    var lexer = Self{ .allocator = allocator };",
  "    lexer.yyg = try lexer.createZeroYyguts();",
  ...
  "",
  "    yyg.yy_state_buf = (yyg.lexer.allocator.alloc(usize, YY_STATE_BUF_SIZE) catch {",
  ...
  "    _ = &yylval_param;",
  "    var lexer = try yylex_init(std.heap.page_allocator);",
