...
const char *skel[] = {
  ...
  "    pub const zlex = \"[[0]].[[1]].[[0+c37736cc]]\";",
  "    pub const flex = \"[[2]].[[6]].[[4]]\";",
  "};",
  "",
  ...
  "            try writer.print(\"L{d}:C{d} - L{d}:C{d}\", .{",
  "                this.first_line,",
  "                this.first_column,",
  "                this.last_line,",
  "                this.last_column",
  ...
  "inline fn ptrDistance(comptime T: type, p1: anytype, p2: anytype) isize {",
  "    const p1addr = @as(isize, @intCast(@intFromPtr(p1)));",
  "    const p2addr = @as(isize, @intCast(@intFromPtr(p2)));",
  "    return @divExact(p2addr - p1addr, @sizeOf(T));",
  "}",
  "",
  ...
  "",
  "    /// clone the current yy_buffer_state as well as the current scanning status in yyg, so it can be resumed in later",
  "    /// check tests/zlex/eof_rules for an example usage",
  "    pub fn clone(this: *const yy_buffer_state, yyg: *yyguts_t) !*yy_buffer_state {",
  "        const b = try this.allocator.create(yy_buffer_state);",
  "        b.* = this.*;",
  "        b.yy_ch_arr = try this.allocator.dupe(u8, this.yy_ch_arr);",
  "        // move yy_ch_buf & yy_buf_pos according to current yyg status",
  "        var d = ptrDistance(u8, this.yy_ch_arr.ptr, this.yy_ch_buf);",
  "        b.yy_ch_buf = movePtr(b.yy_ch_arr.ptr, d);",
  "        d = @intCast(ptrDistance(u8, this.yy_ch_arr.ptr, yyg.yy_c_buf_p));",
  "        b.yy_buf_pos = movePtr(b.yy_ch_arr.ptr, d);",
  "        // critical! restore this hold char back as in yy_ch_arr it has been changed to '\\0'",
  "        b.yy_buf_pos[0] = yyg.yy_hold_char;",
  "        b.yy_n_chars = yyg.yy_n_chars;",
  "        return b;",
  "    }",
  "};",
  "",
  ...
  "    if (@intFromPtr(yyg.yy_buffer_stack) == 0) return true;",
  "    if (@intFromPtr(yyg.yy_buffer_stack[yyg.yy_buffer_stack_top]) == 0) return true;",
  ...
  "pub fn YY_DO_BEFORE_ACTION(yy_cp: [*]u8, yy_bp: [*]u8, yyg: *yyguts_t) void {",
  "	yyg.yytext_r = yy_bp;",
  ...
  "    const maybe_s = brk: {",
  "        const sz = yyg.yytext_r[0..yyg.yyleng_r];",
  "        if (sz[0] == 0) {",
  "            // this could happen when come back from NULL, so deal with it",
  "            break :brk null;",
  "        } else {",
  "            break :brk sz;",
  "        }",
  ...
  "",
  "    m4_define( [[M4_YY_LEX_PROTO]],",
  "               [[(this: *Self, yylval_: *YYSTYPE, yylloc_: *YYLTYPE)]])",
  "]])",
  "",
  "%endif",
  "",
  ...
  "",
  "        if (yydebug) {",
  "            var p: [*]allowzero usize = yyg.yy_state_ptr;",
  "            std.debug.print(\"yy_state dump:\", .{});",
  "            while (ptrLessEqlThan(yyg.yy_state_buf, p)) : (p = p - 1) {",
  ...
  "                var yy_amount_of_matched_text: isize = ptrDistance(u8, yyg.yytext_r, yy_cp);",
  "                yy_amount_of_matched_text -= 1;",
  "",
  ...
  "",
  "                    yyg.yy_c_buf_p = movePtr(yyg.yytext_r, yy_amount_of_matched_text);",
  "",
  ...
  "                    //",
  "",
  "                    const yy_next_state: usize = yy_try_NUL_trans(yy_current_state, yyg);",
  "",
  "                    yy_bp = yyg.yytext_r + yyg.yy_more_len;",
  "",
  "                    if (yydebug) {",
  "                        std.debug.print(\"yy_current_state={d}, yy_next_state={d}\\n\", .{ yy_current_state, yy_next_state });",
  "                    }",
  "",
  "",
  "                    if (yy_next_state != 0) {",
  ...
  "        if (@as(usize, @intCast(ptrDistance(u8, yyg.yytext_r, yyg.yy_c_buf_p))) - yyg.yy_more_len == 1) {",
  ...
  "    number_to_move = @intCast(ptrDistance(u8, yyg.yytext_r, yyg.yy_c_buf_p) - 1);",
  "",
  ...
  "    var yy_current_state: usize = yyg.yy_start;",
  "",
  "%% [15.0] code to get the start state into yy_current_state goes here",
  "",
  "    var yy_cp = movePtr(yyg.yytext_r, @intCast(yyg.yy_more_len));",
  "	while ( ptrLessThan(yy_cp, yyg.yy_c_buf_p)) : ( yy_cp = movePtr(yy_cp, 1) ) {",
  ...
  "///",
  "pub fn yy_try_NUL_trans(yy_current_state_c: usize, yyg: *yyguts_t) usize {",
  "	var yy_is_jam: bool = undefined;",
  "    var yy_current_state = yy_current_state_c;",
  ...
  "[[",
  "pub fn yyunput(c: u8, yy_bp_param: [*]u8, yyg: *yyguts_t) void {",
  "    var yy_current_buffer = yyg.yy_buffer_stack[yyg.yy_buffer_stack_top];",
  "    var yy_cp: [*]allowzero u8 = yyg.yy_c_buf_p;",
  "    var yy_bp = yy_bp_param;",
  "",
  "	// undo effects of setting up yytext",
  "    yy_cp[0] = yyg.yy_hold_char;",
  "",
  "    if (ptrLessThan(yy_cp, movePtr(yy_current_buffer.yy_ch_buf, 2))) {",
  "        // need to shift things up to make room",
  "		// +2 for EOB chars.",
  "        const number_to_move: usize = yyg.yy_n_chars + 2;",
  "        var dest = movePtr(yy_current_buffer.yy_ch_buf, @intCast(yy_current_buffer.yy_buf_size + 2));",
  "        var source = movePtr(yy_current_buffer.yy_ch_buf, @intCast(number_to_move));",
  "",
  "        while (ptrLessThan(yy_current_buffer.yy_ch_buf, source)) {",
  "            dest = movePtr(dest, -1);",
  "            source = movePtr(source, -1);",
  "            dest[0] = source[0];",
  "        }",
  "",
  "        const d = ptrDistance(u8, source, dest);",
  "        yy_cp = movePtr(yy_cp, d);",
  "        yy_bp = movePtr(yy_bp, d);",
  ...
  "		} else {",
  "            // need more input",
  "            const offset: usize = @intCast(ptrDistance(u8, yyg.yytext_r, yyg.yy_c_buf_p));",
  "			yyg.yy_c_buf_p += 1;",
  "",
  ...
  "pub inline fn YY_CURRENT_BUFFER(yyg: *yyguts_t) *allowzero yy_buffer_state {",
  ...
  "    var b = try yyg.arena_allocator.create(yy_buffer_state);",
  "    b.* = yy_buffer_state{};",
  "    b.allocator = yyg.arena_allocator;",
  "    b.yy_buf_size = size;",
  "",
  "	// yy_ch_buf has to be 2 characters longer than the size given because",
  "	// we need to put in 2 end-of-buffer characters.",
  "	//",
  "    b.yy_ch_arr = try b.allocator.alloc(u8, b.yy_buf_size + 2);",
  "    @memset(b.yy_ch_arr, 0);",
  ...
  "		yyg.yy_c_buf_p[0] = yyg.yy_hold_char;",
  "        yy_current_buffer.yy_buf_pos = @ptrCast(yyg.yy_c_buf_p);",
  "        yy_current_buffer.yy_n_chars = yyg.yy_n_chars;",
  "	}",
  "",
  ...
  "        yyg.yy_buffer_stack_arr = try yyg.lexer_.allocator.realloc(yyg.yy_buffer_stack_arr, num_to_alloc);",
  "        yyg.yy_buffer_stack = yyg.yy_buffer_stack_arr.ptr + yyg.yy_buffer_stack_max;",
  "",
  "        // zero only the new slots.",
  "        @memset(yyg.yy_buffer_stack_arr[yyg.yy_buffer_stack_max..num_to_alloc], @ptrFromInt(0));",
  "		yyg.yy_buffer_stack_max = num_to_alloc;",
  "	}",
  "}",
  "",
  ...
  "    }",
  "",
  "    b = try yyg.arena_allocator.create(yy_buffer_state);",
  "    b.allocator = yyg.arena_allocator;",
  "",
  "    b.yy_buf_size = base.len - 2; // - 2 to take care of EOB's",
  "    b.yy_ch_arr = base;",
  "    b.yy_buf_pos = b.yy_ch_arr.ptr;",
  "    b.yy_ch_buf = b.yy_ch_arr.ptr;",
  ...
  "    var buf = try yyg.arena_allocator.alloc(u8, n);",
  ...
  "pub inline fn yyget_out(yyg: *yyguts_t) yyguts_t.OutType {",
  "    return yyg.yyout_r;",
  "}",
  "]])",
  "",
  ...
  "[[",
  "pub inline fn yyset_out(out_dest: yyguts_t.OutType, yyg: *yyguts_t) void {",
  "    yyg.yyout_r = out_dest;",
  "}",
  "]])",
  "",
  ...
  "    lexer.yyg.allocator = lexer.allocator;",
  "    lexer.yyg.arena = std.heap.ArenaAllocator.init(lexer.yyg.allocator);",
  "    lexer.yyg.arena_allocator = lexer.yyg.arena.allocator();",
  ...
  "m4_ifdef([[M4_YY_MAIN]], [[",
  "pub fn main() !u8 {",
  "    @compileError(\"Please copy this function to your scan.l and adapt to your need!\");",
  "",
